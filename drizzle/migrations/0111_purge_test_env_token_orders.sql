...
BEGIN
  ...
  -- Ordini token prima delle transazioni: token_orders.credit_transaction_id le referenzia.
  ...
  DELETE FROM public.legal_acceptances WHERE is_test;
  DELETE FROM public.client_error_log WHERE is_test;
