...
export const SKILL_OPTIONS: Option[] = [
  ...
  { value: "data_acquisition", label: "Data Acquisition (General)" },
  { value: "magneti_marelli_wintax", label: "Magneti Marelli (Wintax / Data Management)" },
  { value: "bosch_racecon", label: "Bosch Motorsport (RaceCon / Data Management)" },
  { value: "motec_i2", label: "MoTeC (i2 / Dashboards)" },
  { value: "cosworth_pi_toolbox", label: "Cosworth (Pi Toolbox / Toolset)" },
  { value: "aim_race_studio", label: "AIM Sport (Race Studio)" },
  { value: "life_racing_data", label: "Life Racing (Data Management)" },
  { value: "efi_technology", label: "EFI Technology (Advanced Data Analysis)" },
  { value: "twod_debenel", label: "2D Debenel (Telemetry & Software)" },
  ...
  // Driving licences
  { value: "licence_car", label: "Car Driving Licence" },
  { value: "licence_car_trailer", label: "Car + Trailer Licence" },
  { value: "licence_hgv", label: "HGV (Truck) Licence" },
  { value: "licence_hgv_trailer", label: "HGV (Truck) + Trailer Licence" },
  { value: "licence_bus", label: "Bus / Coach Licence" },
  { value: "licence_bus_trailer", label: "Bus / Coach + Trailer Licence" },
  // Management, PR & operations
  { value: "sponsor_management", label: "Sponsor Management & Activation" },
  { value: "contract_negotiation", label: "Motorsport Contract Negotiation" },
  { value: "sports_regulations", label: "Sports Regulations & FIA/FIM Compliance" },
  { value: "budgeting_cost_control", label: "Budgeting & Cost Control" },
  { value: "event_ops_planning", label: "Event & Race Operations Planning" },
  { value: "public_relations", label: "Public Relations & Media Management" },
  { value: "crisis_management", label: "Crisis Management" },
  // Hospitality
  { value: "food_safety_haccp", label: "Food Safety & HACCP Certification" },
  { value: "vip_guest_management", label: "VIP Guest Management" },
  { value: "event_setup_teardown", label: "Event Setup & Tear-down" },
  { value: "catering_management", label: "Catering Management" },
  { value: "bar_beverage_management", label: "Bar & Beverage Management" },
  { value: "multilingual_guest_relations", label: "Multilingual Guest Relations" },
  // Media & content
  { value: "action_trackside_photography", label: "Action & Trackside Photography" },
  { value: "studio_portrait_photography", label: "Studio & Portrait Photography" },
  { value: "video_production_4k", label: "4K/8K Video Production" },
  { value: "fpv_drone_piloting", label: "FPV Drone Piloting" },
  { value: "premiere_davinci_editing", label: "Premiere Pro / DaVinci Resolve Editing" },
  { value: "after_effects_motion", label: "After Effects / Motion Graphics" },
  { value: "photoshop_lightroom", label: "Photoshop & Lightroom Post-Processing" },
  { value: "social_media_strategy", label: "Social Media Strategy & Live Coverage" },
  { value: "press_release_writing", label: "Press Release Writing & Media Distribution" },
  { value: "livery_graphic_design", label: "Car & Livery Graphic Design" },
  // Health & performance
  { value: "driver_rehab_prevention", label: "Driver Physical Rehabilitation & Injury Prevention" },
  { value: "manual_therapy_massage", label: "Manual Therapy & Massage" },
  { value: "core_neck_training", label: "Core & Neck Strengthening (G-Force Training)" },
  { value: "ergonomic_cockpit_assessment", label: "Ergonomic & Cockpit Assessment" },
  { value: "biomechanics_testing", label: "Bio-mechanics & Performance Testing" },
  { value: "race_nutrition_planning", label: "Race Nutrition & Hydration Planning" },
];
