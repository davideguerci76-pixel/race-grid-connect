...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PaddockPro — Motorsport freelancers & teams matched by calendar" },
      { name: "description", content: "The elite network that matches freelance mechanics, engineers, telemetrists and data analysts with racing teams by calendar." },
      { property: "og:title", content: "PaddockPro — Motorsport freelancers & teams" },
      { property: "og:description", content: "Publish your calendar, get matched to the next race weekend." },
