...
-- 1) Freelancer past experiences
ALTER TABLE public.freelancer_profiles
  ADD COLUMN IF NOT EXISTS experiences jsonb NOT NULL DEFAULT '[]'::jsonb;

-- 2) Request experience requirements
ALTER TABLE public.requests
  ADD COLUMN IF NOT EXISTS experience_requirements jsonb NOT NULL DEFAULT '[]'::jsonb;

-- 3) Update create_request to accept experience_requirements
...
-- 4) Update recompute_matches to enforce hard experience requirements
