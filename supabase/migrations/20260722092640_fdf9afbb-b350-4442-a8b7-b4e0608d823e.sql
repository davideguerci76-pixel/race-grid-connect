...
-- Languages: freelancer languages + request language requirements
...
-- Recompute matches with hard-language enforcement.
...
-- Extend create_request to accept languages payload.
...
BEGIN
  ...
  INSERT INTO public.requests(
    ...
    experience_requirements, languages
  ) VALUES (
    _uid,
    _payload->>'title',
